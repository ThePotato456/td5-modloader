...
| --- | --- | --- | --- | --- | --- |
| `symbols/btd5-steam-4.8.json` | `NKHook5/Signatures/Signature.cpp`, `NKHook5/Classes/CBaseScreen.h`, `NKHook5/Classes/CBaseTower.h` | `6bcac69de5b76bf2bed49e5db600841bfb42ccb2` | NKHook5 contributors | Steam patterns for main, asset loading, game-screen initialization, tower/weapon factories, virtual initialization/teardown ordering, and a research lead for the tower pop-count field | Renamed through a stable namespace; restricted to the fingerprinted 4.8 map; added prerequisites and validation patterns; independently derived the adjacent `CGameScreen::Uninit` target, native round/money/tower/bloon RTTI/vtable symbols, lives handlers, exact lives write sites, and unique tower pop-count getter/setter functions from the supported executable |
